(() => {
  ...
  var mainBanner = document.querySelector(".main-banner__slider");
  if (mainBanner) {
  ...
  var pcsClass = "product-card-slider__";
  var pcsSlidersClasses = ["pcs-slider-01", "pcs-slider-02"];
  var pcsSlides = document.querySelectorAll(".".concat(pcsClass, "swiper-wrapper > *"));
  if (pcsSlides.length) {
    ...
    const pcsThumbsSwiper01 = new Swiper(
      ".".concat(pcsClass, "swiper--thumbs.").concat(pcsSlidersClasses[0]),
    ...
    const pcsMainSwiper01 = new Swiper(
      ".".concat(pcsClass, "swiper--main.").concat(pcsSlidersClasses[0]),
      pcsMainSwiperConfig
    );
  }
  var csSlides = document.querySelectorAll(
  ...
  if (csSlides.length) {
    ...
    csSwipers.forEach((slider) => {
      ...
      let modulesConfig = [];
      const mSlides = ((_a = slider.dataset) == null ? void 0 : _a.mobSlides) ? slider.dataset.mobSlides === "auto" ? "auto" : +slider.dataset.mobSlides : false;
      const gap = ((_b = slider.dataset) == null ? void 0 : _b.gap) ? +slider.dataset.gap : false;
      const slides = ((_c = slider.dataset) == null ? void 0 : _c.slides) ? +slider.dataset.slides : false;
      ...
      const csSwiperConfig = {
        ...
        on: {
          init: function() {
            this.slides.forEach((slide2) => addCategoryClass(slide2));
  ...
  var ogFilterButtons = document.querySelectorAll(".our-goods__button");
  var ogSlides = null;
  ...
  var tabsContainers = document.querySelectorAll("._nav-slider");
  ...
  var popularCategories = document.querySelectorAll(".popular-categories");
  ...
  function showCorrectCategory(category, slides) {
    ...
    slides.forEach((slide2) => addCategoryClass(slide2, category));
  }
  function addCategoryClass(slide2, buttonCategory) {
    if (!slide2.dataset.slideCategory) return;
    const slideCategories = slide2.dataset.slideCategory.split(",");
    if (buttonCategory === "")
      return slide2.classList.add("".concat(slide2.classList[0], "_show"));
    slide2.classList.remove("".concat(slide2.classList[0], "_show"));
    if (!slideCategories.includes(buttonCategory)) return;
    slide2.classList.add("".concat(slide2.classList[0], "_show"));
  }
